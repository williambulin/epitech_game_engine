...
int main(int argc, char **argv, char **env)
{
  ...
  std::shared_ptr<AudioSource> testAudioSource1 = audioManager.createAudioSource("../song.wav");
  std::shared_ptr<AudioSource> testAudioSource2 = audioManager.createAudioSource("../a.wav", "0");
